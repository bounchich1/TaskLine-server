...
export const templates: Record<string, string> = {
  ...
  ticket_closed:
    'Обращение №{ticket_number} закрыто. Оцените работу поддержки целым числом от 1 до 10.',
  ...
  rating_expired:
    'Срок оценки обращения №{ticket_number} истёк. Для нового вопроса отправьте сообщение.',
  buffer_expired:
    'Ранее отправленные сообщения больше не хранятся. Пожалуйста, отправьте их снова после согласия.',
  buffer_full:
    'Лимит временного хранения достигнут. Примите согласие и отправьте последнее сообщение повторно.',
