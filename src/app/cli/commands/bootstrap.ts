...
/**
 * `bootstrap`: creates the first administrator (BOOTSTRAP_MAX_USER_ID, BOOTSTRAP_NAME).
 * Refuses once an active admin exists; after that, staff are managed in the admin console.
 */
