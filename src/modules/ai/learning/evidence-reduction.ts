...
async function summarizeChunks(step: LearningStep, chunks: Part[][]): Promise<Summary[] | undefined> {
...
async function reduceSummaries(step: LearningStep, initial: Summary[], limit: number): Promise<Summary[] | undefined> {
...
async function reduceRound(step: LearningStep, summaries: Summary[], round: number): Promise<Summary[] | undefined> {
    const next: Summary[] = [];
